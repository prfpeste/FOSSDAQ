...
- The terminal pins are too large for the PCB holes.
- Carefully file down the edges of the pins until they fit into the holes of the perforated circuit board (80 x 20 mm) (BOM Pos 3).
...
- Solder the 6-pole spring-loaded terminal (Pos 3) on the perforated circuit board (80 x 20 mm) (BOM Pos 5) as shown in the image below. 
  - Orange circles indicate the terminal pins.
  - The 6-pole spring-loaded terminal (Pos 5) is mounted on the side of the perforated circuit board (80 x 20 mm) (BOM Pos 5) facing towards you.
  - Arrows denote the direction of the spring loaded terminal ports.
      - The spring loaded terminal ports face down.
...
### 2.3 - Step 4: soldering Vcc wires

|Pos in BOM|Part|Quantity||Tools|
|---|---|---|---|---|
|N/A|Output Terminal PCB|1|      |soldering iron with solder|
|7.1|<a href="https://www.reichelt.de/de/de/shop/produkt/kupferlitze_isoliert_10_m_4_x_0_50_mm_sw_gn_rt_bl-280308">red insulated copper stranded wire (≥ 0,5 mm²; ca. 5 cm each)|5| ||

- Connect all six Vcc pins with five red insulated copper stranded wires (≥ 0,5 mm²; ca. 5 cm each) (BOM Pos 7.1).
- Ensure no connection exists between any Vcc pin and any GND pin.



### 2.5 - Step 5: soldering Vcc wire

|Pos in BOM|Part|Quantity||Tools|
|---|---|---|---|---|
|N/A|Output Terminal PCB|1|      |soldering iron with solder|
|7.2|<a href="https://www.reichelt.de/de/de/shop/produkt/kupferlitze_isoliert_10_m_4_x_0_50_mm_sw_gn_rt_bl-280308">red insulated copper stranded wire (≥ 0,5 mm²; ca. 10 cm each)|1| ||

- Connect one Vcc pin to one red insulated copper stranded wire (≥ 0,5 mm²; ca. 10 cm each) (BOM Pos 7.2).
- Ensure no connection exists between any Vcc pin and any GND pin.



### 2.6 - Step 6: soldering GND wires

|Pos in BOM|Part|Quantity||Tools|
|---|---|---|---|---|
|N/A|Output Terminal PCB|1|      |soldering iron with solder|
|7.3|<a href="https://www.reichelt.de/de/de/shop/produkt/kupferlitze_isoliert_10_m_4_x_0_50_mm_sw_gn_rt_bl-280308">black insulated copper stranded wire (≥ 0,5 mm²; ca. 5 cm each)|5| ||

- Connect all six GND pins with five black insulated copper stranded wires (≥ 0,5 mm²; ca. 5 cm each) (BOM Pos 7.3).
- Ensure no connection exists between any Vcc pin and any GND pin.



### 2.7 - Step 7: soldering GND wire

|Pos in BOM|Part|Quantity||Tools|
|---|---|---|---|---|
|N/A|Output Terminal PCB|1|      |soldering iron with solder|
|7.4|<a href="https://www.reichelt.de/de/de/shop/produkt/kupferlitze_isoliert_10_m_4_x_0_50_mm_sw_gn_rt_bl-280308">black insulated copper stranded wire (≥ 0,5 mm²; ca. 10 cm each)|1| ||

- Connect one Vcc pin to one red insulated copper stranded wire (≥ 0,5 mm²; ca. 10 cm each) (BOM Pos 7.4).
- Ensure no connection exists between any 24 V pin and any GND pin.



### 2.8 - Step 8: soldering SCx wires

|Pos in BOM|Part|Quantity||Tools|
|---|---|---|---|---|
|N/A|Output Terminal PCB|1|      |soldering iron with solder|
|7.5|<a href="https://www.reichelt.de/de/de/shop/produkt/kupferlitze_isoliert_10_m_4_x_0_50_mm_sw_gn_rt_bl-280308">green insulated copper stranded wire (≥ 0,5 mm²; ca. 20 cm each)|6| ||

- Connect all six SCx pins with six green insulated copper stranded wires (≥ 0,5 mm²; ca. 20 cm each) (BOM Pos 7.5).



### 2.9 - Step 9: soldering SDx wires

|Pos in BOM|Part|Quantity||Tools|
|---|---|---|---|---|
|N/A|Output Terminal PCB|1|      |soldering iron with solder|
|7.6|<a href="https://www.reichelt.de/de/de/shop/produkt/kupferlitze_isoliert_10_m_4_x_0_50_mm_sw_gn_rt_bl-280308">blue insulated copper stranded wire (≥ 0,5 mm²; ca. 20 cm each)|6| ||

- Connect all six SCx pins with six blue insulated copper stranded wires (≥ 0,5 mm²; ca. 20 cm each) (BOM Pos 7.6).



### 2.10 - Step 10: twisting SCx and SDx pairs
