...
<img src="../images/ai_terminal.png" alt="" width="700" />  
...
|7.1|<a href="https://www.reichelt.de/de/de/shop/produkt/kupferlitze_isoliert_10_m_4_x_0_50_mm_sw_gn_rt_bl-280308">red insulated copper stranded wire (≥ 0,5 mm²; ca. 5 cm each)|7| ||

- Connect all eight Vcc pins with seven red insulated copper stranded wires (≥ 0,5 mm²; ca. 5 cm each) (BOM Pos 7.1).
...
|---|---|---|---|---|
|N/A|Output Terminal PCB|1|      |soldering iron with solder|
|7.3|<a href="https://www.reichelt.de/de/de/shop/produkt/kupferlitze_isoliert_10_m_4_x_0_50_mm_sw_gn_rt_bl-280308">black insulated copper stranded wire (≥ 0,5 mm²; ca. 5 cm each)|7| ||

- Connect all eight GND pins with seven black insulated copper stranded wires (≥ 0,5 mm²; ca. 5 cm each) (BOM Pos 7.3).
- Ensure no connection exists between any Vcc pin and any GND pin.
...
### 2.8 - Step 8: soldering sensor wires

|Pos in BOM|Part|Quantity||Tools|
|---|---|---|---|---|
|N/A|Output Terminal PCB|1|      |soldering iron with solder|
|7.5|<a href="https://www.reichelt.de/de/de/shop/produkt/kupferlitze_isoliert_10_m_4_x_0_50_mm_sw_gn_rt_bl-280308">green insulated copper stranded wire (≥ 0,5 mm²; ca. 20 cm each)|8| ||

- Connect one green insulated copper stranded wires (≥ 0,5 mm²; ca. 20 cm each) (BOM Pos 7.5) to every Ax pin. 
