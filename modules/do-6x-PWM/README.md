...
6-channel digital output module with PWM functionality for the FOSSDAQ system.
...
The `do-PWM-1to6x` module is the first fully developed digital output card of the FOSSDAQ system. It is intended for simple and low-cost control of devices with an digital input in educational and laboratory setups.

## Features

- 1-6 digital output channels
- Designed for 0-20 V signal output
- choose between PWM or simple on off switch per channel
...
- Local logic/sensor supply: 1.5-20 V generated locally
