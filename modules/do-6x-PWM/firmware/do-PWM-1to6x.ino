...
String ID="do-6x-PWM_";  // ID prefex of the specific Arduino. The '_' at the end is necessary!
...
switch (initStatus) {
    ...
    if (Serial.available() > 0) {                                         // if message received,
      ...
      if (noSettings == 0) {                                              // only execute if the length of the settings array is greater than zero 
        ...
        if (commaIndexSet != -1) {                                        // if a comma is present, 
          ...
          switch (indexSet) {
            case 0:
              if (setting != 1 && setting != 2 && setting != 3) {         // if sent setting is NOT valid (query every valid setting with '!=' and link them with '&&'),
  ...
  case 3:
    ...
    //---------------------------------------------------------------------------------------------------------------------------------------------------------------------
    if (settings[0] == 2 || settings[0] == 3) pinMode(5, OUTPUT);
    if (settings[1] == 2 || settings[1] == 3) pinMode(6, OUTPUT);
    if (settings[2] == 2 || settings[2] == 3) pinMode(9, OUTPUT);
    if (settings[3] == 2 || settings[3] == 3) pinMode(10, OUTPUT);
    if (settings[4] == 2 || settings[4] == 3) pinMode(3, OUTPUT);
    if (settings[5] == 2 || settings[5] == 3) pinMode(11, OUTPUT);
    //=====================================================================================================================================================================    
    break;
  ...
  if (Serial.available() > 0) {                                           // if message received 
    ...
    switch (controllIndex) {
      case 0:
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------------------------
        digitalOutPWM(5, command, controllIndex);
        //=================================================================================================================================================================
        break;
      ...
      case 1:
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------------------------
        digitalOutPWM(6, command, controllIndex);
        //=================================================================================================================================================================
        break;
      ...
      case 2:
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------------------------
        digitalOutPWM(9, command, controllIndex);
        //=================================================================================================================================================================
        break;

      case 3:
        //=================================================================================================================================================================
        // ### // Insert specific code to control actor 3 here ###
        //-----------------------------------------------------------------------------------------------------------------------------------------------------------------
        digitalOutPWM(10, command, controllIndex);
        //=================================================================================================================================================================
        break;

      case 4:
        //=================================================================================================================================================================
        // ### // Insert specific code to control actor 4 here ###
        //-----------------------------------------------------------------------------------------------------------------------------------------------------------------
        digitalOutPWM(3, command, controllIndex);
        //=================================================================================================================================================================
        break;

      case 5:
        //=================================================================================================================================================================
        // ### // Insert specific code to control actor 5 here ###
        //-----------------------------------------------------------------------------------------------------------------------------------------------------------------
        digitalOutPWM(11, command, controllIndex);
        //=================================================================================================================================================================
        break;
  ...
  if (Serial.available() > 0) {                                           // if message received 
    ...
    switch (measureingIndex) {
      case 0:
        ...
        //-----------------------------------------------------------------------------------------------------------------------------------------------------------------
        measurement = 1234; // Example line. The measured value must be written to the variable 'measurement'!
        //=================================================================================================================================================================        break;
        break;

      case 1:
        //=================================================================================================================================================================
        // ### Insert specific code to read the measurement value from sensor 1 here ###
        //-----------------------------------------------------------------------------------------------------------------------------------------------------------------
