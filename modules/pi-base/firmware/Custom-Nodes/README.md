...
This is a Node-RED node package (npm name `fossdaq`) providing three custom
...
3. Add a new entry to the object in **`fossdaq-config.js`**, keyed by that
   ...
   mode is chosen during the handshake (see the `"ttyUSB"` entry for an
